...
Y la quinta, que no salió del prototipo sino de la investigación externa ([`hallazgos-investigacion-sandbox.md`](../../historico/investigacion/hallazgos-investigacion-sandbox.md) §7):
